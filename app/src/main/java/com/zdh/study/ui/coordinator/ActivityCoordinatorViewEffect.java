...
import com.zdh.study.databinding.ActivityCoordinatorViewpagerEffectBinding;
...
public class ActivityCoordinatorViewEffect extends BaseActivity<ActivityCoordinatorViewpagerEffectBinding, CoordinatorViewModel> {
    ...
    public int initContentView(Bundle savedInstanceState) {
        return R.layout.activity_coordinator_viewpager_effect;
    }
    ...
    private void initAppbar() {
        ...
        appBarStateChangeListener.setOnStateChangedListener(new AppBarStateChangeListener.OnStateChangedListener() {
            @Override
        ...
        binding.mainAppbar.addOnOffsetChangedListener(appBarStateChangeListener);
